...
public class PublicWifiDto {
    ...
    public PublicWifiDto(String distance, String manageNo, String borough, String wifiName, String streetAddress, String detailAddress, String whereInstalled, String typeOfInstall, String companyOfInstall, String service, String typeOfNet, Integer year, String inOrOut, Long LAT, Long LNT, LocalDateTime workTime) {
        ...
        this.whereInstalled = whereInstalled;
